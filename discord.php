...
<html lang="en">
  <head>
    ...
    <title>Bot Discord | Mercure Hosting</title>
  ...
  <body class="web overlay">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="discord.php">Bot Discord</a></li>
    ...
    <div class="container h">
      <h1 class="animated bounceInLeft"><span>Bot </span> Discord<p></h1>
  ...
  <div class="start">
    <div class="container">
           ...
           <h2>Choisissez le forfait de vos reve</h2>
