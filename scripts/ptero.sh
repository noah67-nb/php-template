...
echo -e "\e[1;33mMerci de ne pas annuler le script d'installation Pterodactyl ni de vous déconnecter du SSH\e[0m"

echo -e "\e[1;36mInstallation de Pterodactyl en cours\e[0m"
